...
รอบถัดมาผู้ใช้ยืนยันว่าเมนู **ดูทุกข้อ** และจับคู่แบบช่องผ่าน แต่จับคู่แบบลากเส้นเริ่มลากได้เฉพาะจุดวงกลมฝั่งซ้าย จึงแก้ให้กดค้างบนพื้นที่การ์ดแล้วลากได้ทั้งสองทิศทางโดยไม่แย่งการเลื่อนแนวตั้ง ผล local runtime ยืนยันซ้าย→ขวา, ขวา→ซ้าย, กดค้าง และการยกเลิก gesture แนวตั้ง พร้อม deploy/ล็อก candidate `r6` และตรวจ canonical Staging แล้ว เหลือทดสอบซ้ำบน iPad จริง
