...
และการคงคำตอบเดิม แป้นคณิตศาสตร์ของช่องคำตอบผ่านแล้วบน `r7` แต่การเปลี่ยนโค้ด
เครื่องคิดเลขทำให้ต้องยืนยันการคั่นหลักพันบน iPad จริงอีกครั้งบน `r8`; หลังจากนั้น
เหลือกระดาษทดและ camera/file picker บน candidate เดียวกัน
