...
ตรวจจาก repository: 21 สิงหาคม 2026
...
- หน้าสร้างงานโหลดบทบาท ห้องเรียน โจทย์ และชุดโจทย์พร้อมกันด้วย payload สำหรับตัวเลือกโดยเฉพาะ และโหลด JavaScript ของคลังตัวเลือกเมื่อเข้าสู่ขั้นเลือกโจทย์ ส่วนหน้าแก้ไขดึงเฉพาะค่าที่แก้ได้
...
- หน้าหลักของครูแสดงเฉพาะข้อมูลจริงของเจ้าของบัญชี: จำนวนห้องเรียน นักเรียนรวม โจทย์ในคลัง ชุดโจทย์ พร้อมรายการล่าสุดของทั้งสามอย่างและปุ่มสร้าง — บัญชีที่ยังไม่มีข้อมูลจะเห็นการ์ดเริ่มต้นใช้งานแทนตัวเลข 0
- จำนวนโจทย์ในชุดนับเฉพาะ id ที่ยังหาโจทย์เจอ (question_ids ค้างได้เมื่อโจทย์ถูกลบ) ให้ตรงกับที่หน้าคลังชุดโจทย์แสดง
- ยอดรวมและรายการล่าสุดของโจทย์/ชุดโจทย์มาจาก query เดียวกันด้วย `count: 'exact'` คู่กับ `limit` ส่วนห้องเรียนนับนักเรียนและชุดข้อสอบผ่าน relation เหมือนหน้ารวมห้องเรียน
