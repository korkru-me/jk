...
1. Apply migration ตามลำดับ: `20260830062722_add_seb_secure_exam_mode.sql` แล้ว `20260830072842_add_android_monitored_exam_access.sql`
...
1. ครูเปิด “ห้องคุมสอบสด” ก่อนให้นักเรียนกดเริ่ม
...
6. ระหว่างสอบครูติดตาม heartbeat, ออกจากแท็บ/แอป, fullscreen, clipboard และการเปิดพร้อมกันหลายจุดในห้องคุมสอบ
