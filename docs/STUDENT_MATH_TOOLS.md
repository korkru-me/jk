...
สถานะ: **เฟส 2 — safe math engine, DEG/RAD persistence และแป้นคณิตศาสตร์พัฒนาแล้ว**

เอกสารนี้กำหนดขอบเขตของแป้นคณิตศาสตร์ เครื่องคิดเลขวิทยาศาสตร์ กระดาษทดของนักเรียน การแนบวิธีทำ และกระดานสอนของครู เฟส 1 เพิ่ม schema, RLS, private Storage, Server Actions และสวิตช์ในหน้าสร้าง/แก้ไขงาน ส่วนเฟส 2 เปิดแป้นคณิตศาสตร์และ DEG/RAD ในช่องคำตอบตัวเลขแล้ว เครื่องคิดเลขและพื้นที่เขียนยังรอเฟสของแต่ละเครื่องมือ
...
สถานะปัจจุบัน: เฟส 0–2 เสร็จในโค้ด แป้นคณิตศาสตร์และ DEG/RAD แสดงในช่องคำตอบตัวเลขแล้ว เฟส 3–8 ยังไม่เริ่ม จึงยังไม่มีเครื่องคิดเลข กระดาษทด การแนบ artifact และโหมดสอนใน production UI
