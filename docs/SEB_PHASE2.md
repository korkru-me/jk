...
**Lab ในแผนเดิม ไม่ใช่แผนติดตั้งปัจจุบัน:** ผู้ใช้เริ่ม N1 ของ [แผนใหม่ไม่เพิ่ม SEB Server](SEB_NO_SERVER_PLAN.md) ยังไม่มีการอนุมัติให้เปิด/ติดตั้ง lab, เช่าบริการ หรือใช้ server connector ใน production จากการเริ่ม N1 เก็บเอกสารและโค้ดนี้ไว้เป็นประวัติ ไม่ลบทิ้งหรือถือว่าการทดสอบผ่านแล้ว
