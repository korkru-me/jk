...
export const PROFILE_BY_TYPE: Record<QuestionType, ImportProfile> = {
  ...
  fill_blank: {
    ...
    rules: [
      NUMBERING,
      { id: 'blank-answer', text: 'พิมพ์ประโยคเต็มพร้อมคำตอบ แล้วทำเครื่องหมายเฉพาะคำที่เป็นคำตอบด้วยตัวอักษรสีแดง ปากกาเน้นข้อความ หรือตัวหนา — ระบบจะเปลี่ยนคำนั้นเป็นช่องให้นักเรียนกรอก' },
