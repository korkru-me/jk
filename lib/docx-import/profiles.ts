...
export const PROFILE_BY_TYPE: Record<QuestionType, ImportProfile> = {
  ...
  written: {
    ...
    blurb: 'โจทย์คำนวณที่ตอบเป็นตัวเลข ระบบอ่านตัวโจทย์และข้อย่อยให้ เฉลยยังต้องพิมพ์เอง',
    status: 'ready',
    rules: [
      NUMBERING,
      { id: 'parts', text: 'ข้อย่อย ก) ข) ค) ให้ใช้รายการย่อยของ Word (กดเพิ่มระดับ) ระบบจะแยกเป็นช่องคำตอบให้ข้อละช่อง' },
      EQUATION,
    ],
    sample: [
      line('heading', t('ใบงานที่ 3 แรงและกฎการเคลื่อนที่')),
      line('question', t('วัตถุมวล 5 กิโลกรัม ถูกแรง 20 นิวตันกระทำในแนวราบ')),
      line('part', t('จงหาความเร่งของวัตถุ')),
      line('part', t('ถ้าวัตถุเริ่มจากหยุดนิ่ง หลังจาก 4 วินาที วัตถุมีความเร็วเท่าใด')),
      line('question', t('นักเรียนเดินทางจากบ้านไปโรงเรียน 1,200 เมตร ใช้เวลา 15 นาที จงหาอัตราเร็วเฉลี่ยในหน่วยเมตรต่อวินาที')),
    ],
    limits: [
      'ยังอ่านเฉลยจากไฟล์ไม่ได้ — ต้องกด "แก้ไข" แล้วพิมพ์สูตรหรือคำตอบเองทุกข้อ ไม่อย่างนั้นข้อนั้นจะนำเข้าไม่ได้',
