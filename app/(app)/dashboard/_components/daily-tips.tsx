  ...
  return (
    <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 relative">
      <button
        ...
        className="absolute top-3 right-3 w-5 h-5 rounded-full flex items-center justify-center text-amber-400 hover:bg-amber-100 hover:text-amber-600 transition-colors"
      >
        <X className="w-3 h-3" />
      </button>
      <div className="flex items-start gap-2.5 pr-4">
        ...
        <div>
          ...
          <p className="text-xs text-amber-700 leading-relaxed">{tip.text}</p>
          <button className="flex items-center gap-1 text-xs font-semibold text-amber-700 hover:text-amber-900 mt-2 transition-colors">
