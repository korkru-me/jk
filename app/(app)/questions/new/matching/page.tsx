  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-foreground">สร้างโจทย์จับคู่</h1>
          <p className="text-sm text-muted-foreground mt-1">นักเรียนจับคู่รายการซ้ายกับขวา คอลัมน์ขวาถูกสลับลำดับแบบสุ่ม</p>
        </div>
      </div>
