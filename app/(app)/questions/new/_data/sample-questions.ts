...
export interface SampleQuestion {
  ...
  title: string
  /**
   * What this particular sample is showing, when a type has more than one.
   * จับคู่ has two answering layouts the teacher picks between, and reading which is
   * which off two otherwise similar previews is not something to leave to
   * guesswork.
   */
  variantLabel?: string
...
/** One or more samples per type, shown in order. Most types have exactly one. */
export const SAMPLE_QUESTIONS: Record<QuestionType, SampleQuestion[]> = {
  ...
  // Two samples, because จับคู่ is the one type whose answering is a choice the
  // teacher makes. The pairs differ so the pair of previews doubles as two
  // worked examples rather than the same question printed twice.
  matching: [
    {
      title: 'จับคู่ปริมาณทางฟิสิกส์กับหน่วยเอสไอ',
      variantLabel: 'ลากไปวางในช่อง',
      props: {
        ...
        variables: [],
        answerParts: [],
        matchingConfig: { answer_mode: 'slots' },
        matchingPairs: [
    ...
    {
      title: 'จับคู่นักวิทยาศาสตร์กับผลงาน',
      variantLabel: 'โยงเส้น',
      props: {
        questionType: 'matching',
        questionText: 'จงโยงเส้นจับคู่นักวิทยาศาสตร์กับผลงานหรือกฎที่เขาเสนอไว้ให้ถูกต้อง',
        isRandom: false,
        variables: [],
        answerParts: [],
        matchingConfig: { answer_mode: 'lines' },
        matchingPairs: [
          { left_text: 'ไอแซก นิวตัน', right_text: 'กฎการเคลื่อนที่และกฎแรงโน้มถ่วง' },
          { left_text: 'อัลเบิร์ต ไอน์สไตน์', right_text: 'ทฤษฎีสัมพัทธภาพ' },
          { left_text: 'มารี กูรี', right_text: 'การค้นพบธาตุกัมมันตรังสีเรเดียม' },
          { left_text: 'ชาลส์ ดาร์วิน', right_text: 'ทฤษฎีวิวัฒนาการโดยการคัดเลือกตามธรรมชาติ' },
        ],
      },
    },
  ],
