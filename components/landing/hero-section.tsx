  ...
  return (
    <section className="relative overflow-hidden bg-card">
      ...
      <div className="relative mx-auto max-w-6xl px-4 pb-24 pt-20 text-center sm:pt-32">
        {/* Badge */}
        <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-warning/20 bg-warning/10 px-4 py-1.5 text-sm font-medium text-warning dark:border-amber-800/60 dark:bg-amber-950/60">
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
          <Link
            href="/signup"
            className="inline-flex items-center gap-2 rounded-xl bg-primary px-8 py-4 text-base font-semibold text-white shadow-lg shadow-indigo-500/25 hover:bg-primary/90 transition-all hover:shadow-indigo-500/40 hover:-translate-y-0.5"
          >
